...
//create a pre defned username and password since we do not have database
$acc_username = "SamanthaSajul";
$acc_password = "samanthasajul101802";
$acc_fullname = "Samantha F. Sajul";
$acc_address = "Buenavista, Marinduque";
...
if (isset($_REQUEST['login_button']) === true){
 //get the username and password from the form and compare to the predefined username and password
	...
	}//end of current username and password
