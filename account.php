        ...
        <div class="bg-white shadow rounded overflow-hidden">
            ...
            <div class="px-4 py-3">
                ...
                <div class="p-4 rounded shadow-sm bg-light">
                    <p class="font-italic mb-0">Reading Wattpad Books</p>
                    <p class="font-italic mb-0">Drawing and Dancing </p>
                    <p class="font-italic mb-0">Watching KDrama and Thai Series</p>
                </div>
            </div>
